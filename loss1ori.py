...
def batch_soft(dists, pids, margin, batch_precision_at_k=None):
    """Computes the batch-hard loss from arxiv.org/abs/1703.07737.
    ...
    with tf.name_scope("batch_soft"):
        ...
        furthest_positive = tf.reduce_min(dists*tf.cast(positive_mask, tf.float32), axis=1)
